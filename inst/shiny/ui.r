...
shinyUI(navbarPage(theme = "bootstrap.css",
                   tags$head(tags$style(HTML("
                                             ...
                                             tabPanel(uiOutput("ini"),
                                                      ...
                                                      h1(uiOutput("sigla"), 
                                                         ...
                                                         withTags({
                                                           div(id="language", class="form-group shiny-input-radiogroup shiny-input-container shiny-input-container-inline",style="text-align: center;",
                                                               #label(`for`="language",
                                                               #span("Escolha seu idioma")),
                                                               div(class="shiny-options-group",
                                                                   div(class="radio-inline",
                                                                       input(type="radio", name="language", value="br", checked="checked"),
                                                      ...
                                                      tabPanel(uiOutput("utbanco"),                     
                                                               column(3,
                                                                      wellPanel(
                                                                                ...
                                                                                textInput('textanol',h5(uiOutput("templ6")),value='2015/1'),
                                                                                textInput('textname',h5(uiOutput("templ7")),value='Ambrósio da Silva')
                                                                                )),
                                                               column(8,
                                                                      wellPanel(
                                                      ...
                                                      tabPanel(actionButton('Sair',uiOutput('sair')))
                                                      )) 
