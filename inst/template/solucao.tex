...
%% headings
\markboth{\textnormal{\bf \large Gabarito: \myID}}%
{\textnormal{\bf \large Gabarito: \myID}}
...
\textbf{\large{Gabarito \myDate \hfill Exam ID \myID}}

\vspace*{2cm}

\begin{tabular}{p{14cm}}
\textbf{Nome:} \hrule \\[1.5cm]
\textbf{Matrícula:} \hrule \\[1.5cm]
\end{tabular}
